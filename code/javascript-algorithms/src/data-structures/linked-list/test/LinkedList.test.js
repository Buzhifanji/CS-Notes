...
describe('LinkedList', () => {
    ...
    // 验证 链表 delelte
    it('should delelte node by value from linked list', () => {
        const linkedList = new LinkedList()
        ...
        expect(linkedList.toString()).toBe('1,1,1,2,4,5')
    ...
    // 验证 链表 自定义 对比函数 comparatorFunction
    ...
    // 验证 链表 自定义 comparatorFunction
    it('should find preferring callback over compare function', () => {
        const greateThan = (value, compareTo) => (value > compareTo ? 0 : 1)

        const linkedList = new LinkedList(greateThan)
